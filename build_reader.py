...
.next-chapter-cta {
    ...
    overflow: hidden;
    white-space: nowrap;
    transition: max-width .3s ease, padding .3s ease, box-shadow .3s ease, transform .3s ease;
}
...
.next-chapter-cta .next-cta-label,
.next-chapter-cta .next-cta-title {
    transition: max-width .3s ease, opacity .3s ease;
    max-width: 0;
    opacity: 0;
    overflow: hidden;
}
.next-chapter-cta.expanded .next-cta-label,
.next-chapter-cta.expanded .next-cta-title {
    max-width: 280px;
    opacity: 1;
}
.next-chapter-cta:hover:not(.expanded) { transform: scale(1.08); }
/* 系列完成庆祝 modal */
.series-celebration {
    position: fixed;
    inset: 0;
...
(function() {
    ...
    cta.innerHTML = '<span class="next-cta-label">下一章</span><span class="next-cta-title"></span><span class="next-cta-arrow">→</span>';
