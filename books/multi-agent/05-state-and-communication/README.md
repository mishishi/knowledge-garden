...
> 第 4 章我们看了 5 种编排模式——本质上就是"Agent 之间怎么连"。本章深入一层：连起来之后，**数据怎么传、状态怎么管**。这是 Multi-Agent 系统从 demo 走向生产的关键工程问题。
...
[06. 失败的艺术](../06-failure-handling/) —— Multi-Agent 系统的失败是单 Agent 的 N 倍，本章讲怎么防御。
